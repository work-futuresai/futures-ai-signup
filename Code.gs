...
const MAPPING = {
  // 通訊區域
  "area_n": "北", "area_c": "中", "area_s": "南", "area_e": "東", "area_o": "離島", 
  ...
  // 👇 新增：年齡層對照
  "age_1": "20以下", "age_2": "20~35", "age_3": "35~50", "age_4": "50~65", "age_5": "65以上"
};
...
function processFormSubmission(formData) {
  try {
    ...
    if (code === 200 || code === 0) {
      ...
      return { success: false, msg: "Google 表單拒絕 (代碼 " + code + ")" };
    }
